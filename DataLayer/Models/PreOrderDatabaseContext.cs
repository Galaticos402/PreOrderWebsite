...
{
    public partial class PreOrderDatabaseContext : DbContext
    {
        public PreOrderDatabaseContext()
        {
        }

        public PreOrderDatabaseContext(DbContextOptions<PreOrderDatabaseContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountOrder>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("FK_AccountOrder_Account1");

                entity.HasOne(d => d.Product)
                    .WithMany(p => p.AccountOrders)
                    .HasForeignKey(d => d.ProductId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_AccountOrder_Product");
            });
